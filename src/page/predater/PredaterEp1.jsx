    ...
    <div className="max-w-[980px]  mx-auto border-[3px] mt-[30px] scroll-smooth">
      ...
      <div className="relative">
        ...
        <img
          ...
          src="predater-img/ep1/full-1.png"
          alt=""
        />
        {/*3 Box-Content */}
      ...
      <div className="box-1 relative">
        <img
          ...
          src="predater-img/ep1/full-2.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="predater-img/ep1/full-3.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
            ...
            <div className="flex flex-row justify-start items-center relative top-[3%]  mx-[8%]  h-[28%] ">
              ...
              ></motion.div>
              <motion.div
                className="w-[24%] ml-[2%]  h-full border-[1px] border-black"
                initial={{ opacity: 0, x: -75 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                style={{
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="predater-img/ep1/full-4.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
            <div className="relative top-[63%]  mx-[8%]  h-[28%] ">
              <motion.div
                className="w-[25%] ml-[11%]  h-full border-[1px] border-black"
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="predater-img/ep1/full-5.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="predater-img/ep1/full-6.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="predater-img/ep1/full-7.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="predater-img/ep1/full-8.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
            ...
            <div className="flex justify-end relative top-[36.5%]  mx-[8%]  h-[31%] ">
              <motion.div
                className="w-[55%]  h-full border-[1px] border-black"
                initial={{ opacity: 0, x: -75 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: 0.25 }}
                style={{
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="predater-img/ep1/full-9.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
