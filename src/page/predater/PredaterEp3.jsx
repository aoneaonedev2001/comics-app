    ...
    <div className="max-w-[980px]  mx-auto border-[3px] mt-[30px] scroll-smooth">
      ...
      <div className="relative">
        ...
        <img
          ...
          src="predater-img/ep3/full-1.png"
          alt=""
        />
        {/*3 Box-Content */}
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
            ...
            <div className="flex flex-row justify-between items-center relative top-[25%]  mx-[4%]  h-[27%] ">
              <motion.div
                className="w-[40%]  h-full border-[1px] border-black"
              ...
              ></motion.div>
              <motion.div
                className="w-[27%]  h-full border-[1px] border-black"
                initial={{ opacity: 0, x: -75 }}
                whileInView={{ opacity: 1, x: 0 }}
      ...
      <div className="box-1 relative">
        <img
          ...
          src="predater-img/ep3/full-2.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="predater-img/ep3/full-3.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="predater-img/ep3/full-4.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
            <div className="relative flex justify-center top-[40%]  mx-[1%]  h-[16%] ">
              <motion.div
                className="w-[64%]  h-full border-[1px] border-black"
                initial={{ opacity: 0, x: 75 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: 0.25 }}
                style={{
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="predater-img/ep3/full-5.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="predater-img/ep3/full-6.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
            <div className="flex flex-row justify-center items-center relative top-[4%]  mx-[1%]  h-[13%] ">
              <motion.div
                className="w-[94%]  h-full border-[1px] border-black"
                initial={{ opacity: 0, x: -75 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: 0.25 }}
                style={{
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="predater-img/ep3/full-7.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="predater-img/ep3/full-8.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="predater-img/ep3/full-9.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
            <div className="relative flex justify-end items-center top-[51%]  mx-[1%]  h-[15%] ">
              <motion.div
                className="w-[68%]  h-full border-[1px] border-black"
                initial={{ opacity: 0, x: -75 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: 0.25 }}
                style={{
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="predater-img/ep3/full-10.png"
          alt=""
        />
        <div className="absolute inset-0 ">
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="predater-img/ep3/full-11.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
