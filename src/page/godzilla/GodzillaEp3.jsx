    ...
    <div className="max-w-[980px]  mx-auto border-[3px] mt-[30px] scroll-smooth">
      ...
      <div className="relative">
        ...
        <img
          ...
          src="godzilla-img/ep3/full-1.png"
          alt=""
        />
        {/*3 Box-Content */}
      ...
      <div className="box-1 relative">
        <img
          ...
          src="godzilla-img/ep3/full-2.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
            ...
            <div className="flex flex-row justify-start items-center relative top-[11%]  mx-[5%]  h-[35%] ">
              <motion.div
                className="w-[61%]  h-full border-[1px] border-black"
                initial={{ opacity: 0, x: -75 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: 0.25 }}
                style={{
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="godzilla-img/ep3/full-3.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
            <div className="flex flex-row justify-between items-center relative top-[2%]  mx-[2%]  h-[31%] ">
              <motion.div
                className="w-[33%]  h-full border-[1px] border-black"
                initial={{ opacity: 0, x: -75 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: 0.25 }}
                style={{
              ...
              ></motion.div>
              <motion.div
                className="w-[66%]  h-full border-[1px] border-black"
                initial={{ opacity: 0, x: -75 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                style={{
            ...
            <div className="flex flex-row justify-end items-center relative top-[4%]  mx-[2%]  h-[33%] ">
              <motion.div
                className="w-[46%]  h-full border-[1px] border-black"
                initial={{ opacity: 0, x: -75 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: 0.25 }}
                style={{
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="godzilla-img/ep3/full-4.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="godzilla-img/ep3/full-5.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="godzilla-img/ep3/full-6.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="godzilla-img/ep3/full-7.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
            <div className="flex flex-row justify-end items-center relative top-[2%]  mx-[3%]  h-[46%] ">
              <motion.div
                className="w-[30%] mr-[2%]  h-full border-[1px] border-black"
                initial={{ opacity: 0, x: -75 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: 0.25 }}
                style={{
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="godzilla-img/ep3/full-8.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="godzilla-img/ep3/full-9.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="godzilla-img/ep3/full-10.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
      ...
      <div className="box-1 relative">
        <img
          className="box-items-1 max-w-full "
          src="godzilla-img/ep3/full-11.png"
          alt=""
        />
        <div className="absolute inset-0 ">
          <div className="max-h-[100%] h-[1800px]">
