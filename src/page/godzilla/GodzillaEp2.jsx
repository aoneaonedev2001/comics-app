...
const GodzillaEp2 = () => {
  ...
  {/*1 Page */}
    ...
    {/*2 Backgroud-Img */}
        <img className=' max-w-full ' src="godzilla-img/ep2/full-1.png" alt="" />
    {/*3 Box-Content */}
  ...
  {/* 2 */}
      <div className='box-1 relative'>
        <img className='box-items-1 max-w-full ' src="godzilla-img/ep2/full-2.png" alt="" />
        <div className='absolute inset-0 '>
          <div className='max-h-[100%] h-[1800px]'>
    ...
    {/* 3 */}
       <div className='box-1 relative'>
        <img className='box-items-1 max-w-full ' src="godzilla-img/ep2/full-3.png" alt="" />
        <div className='absolute inset-0 '>
          <div className='max-h-[100%] h-[1800px]'>
          <div className='flex flex-row justify-start items-center relative top-[31%]  mx-[5%]  h-[37%] '>
                <motion.div className='w-[62%]  h-full border-[1px] border-black'
      ...
      {/* 4 */}
      <div className='box-1 relative'>
      <img className='box-items-1 max-w-full ' src="godzilla-img/ep2/full-4.png" alt="" />
      <div className='absolute inset-0 '>
        <div className='max-h-[100%] h-[1800px]'>
    ...
    {/* 5 */}
    <div className='box-1 relative'>
      <img className='box-items-1 max-w-full ' src="godzilla-img/ep2/full-5.png" alt="" />
      <div className='absolute inset-0 '>
        <div className='max-h-[100%] h-[1800px]'>
    ...
    {/* 6 */}
    <div className='box-1 relative'>
      <img className='box-items-1 max-w-full ' src="godzilla-img/ep2/full-6.png" alt="" />
      <div className='absolute inset-0 '>
        <div className='max-h-[100%] h-[1800px]'>
    ...
    {/* 7 */}
    <div className='box-1 relative'>
        <img className='box-items-1 max-w-full ' src="godzilla-img/ep2/full-7.png" alt="" />
        <div className='absolute inset-0 '>
          <div className='max-h-[100%] h-[1800px]'>
            <div className='flex flex-row justify-end items-center relative top-[5%]  mx-[3%]  h-[35%] '>
                <motion.div className='w-[23%]  h-full border-[1px] border-black'
