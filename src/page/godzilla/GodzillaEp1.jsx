...
const GodzillaEp1 = () => {
  ...
  {/*1 Page */}
    ...
    {/*2 Backgroud-Img */}
        <img className=' max-w-full ' src="godzilla-img/ep1/full-1.png" alt="" />
    {/*3 Box-Content */}
  ...
  {/* 2 */}
      <div className='box-1 relative'>
        <img className='box-items-1 max-w-full ' src="godzilla-img/ep1/full-2.png" alt="" />
        <div className='absolute inset-0 '>
          <div className='max-h-[100%] h-[1800px]'>
          <div className='relative flex justify-between top-[4%]  mx-[5%]  h-[34%] '>
                ...
                <motion.div className='w-[50%] ml-[3%]  h-full '
    ...
    {/* 3 */}
       <div className='box-1 relative'>
        <img className='box-items-1 max-w-full ' src="godzilla-img/ep1/full-3.png" alt="" />
        <div className='absolute inset-0 '>
          <div className='max-h-[100%] h-[1800px]'>
      ...
      {/* 4 */}
      <div className='box-1 relative'>
      <img className='box-items-1 max-w-full ' src="godzilla-img/ep1/full-4.png" alt="" />
      <div className='absolute inset-0 '>
        <div className='max-h-[100%] h-[1800px]'>
        <div className='flex flex-row justify-between items-center relative top-[3%]  mx-[5%]  h-[35%] '>
                <motion.div className='w-[32%]  h-full border-[1px] border-black'
            ...
            <div className='flex flex-row justify-start items-center relative top-[27%]  mx-[5%]  h-[34%] '>
                <motion.div className='w-[42%]  h-full border-[1px] border-black'
    ...
    {/* 5 */}
    <div className='box-1 relative'>
      <img className='box-items-1 max-w-full ' src="godzilla-img/ep1/full-5.png" alt="" />
      <div className='absolute inset-0 '>
        <div className='max-h-[100%] h-[1800px]'>
    ...
    {/* 6 */}
    <div className='box-1 relative'>
      <img className='box-items-1 max-w-full ' src="godzilla-img/ep1/full-6.png" alt="" />
      <div className='absolute inset-0 '>
        <div className='max-h-[100%] h-[1800px]'>
        <div className='flex flex-row justify-between items-center relative top-[4%]  mx-[8%]  h-[26%] '>
                <motion.div className='w-[45%]  h-full border-[1px] border-black'
            ...
            <div className='relative flex justify-start top-[10%]  mx-[8%]  h-[59%] '>
                <motion.div className='w-[29%]  h-full border-[1px] border-black'
    ...
    {/* 7 */}
    <div className='box-1 relative'>
        <img className='box-items-1 max-w-full ' src="godzilla-img/ep1/full-7.png" alt="" />
        <div className='absolute inset-0 '>
          <div className='max-h-[100%] h-[1800px]'>
    ...
    {/* 8 */}
    <div className='box-1 relative'>
        <img className='box-items-1 max-w-full ' src="godzilla-img/ep1/full-8.png" alt="" />
        <div className='absolute inset-0 '>
          <div className='max-h-[100%] h-[1800px]'>
       ...
       {/* 9 */}
    <div className='box-1 relative'>
        <img className='box-items-1 max-w-full ' src="godzilla-img/ep1/full-9.png" alt="" />
        <div className='absolute inset-0 '>
          <div className='max-h-[100%] h-[1800px]'>
       ...
       {/* 10 */}
    <div className='box-1 relative'>
        <img className='box-items-1 max-w-full ' src="godzilla-img/ep1/full-10.png" alt="" />
        <div className='absolute inset-0 '>
          <div className='max-h-[100%] h-[1800px]'>
       ...
       {/* 11 */}
    <div className='box-1 relative'>
        <img className='box-items-1 max-w-full ' src="godzilla-img/ep1/full-11.png" alt="" />
        <div className='absolute inset-0 '>
          <div className='max-h-[100%] h-[1800px]'>
