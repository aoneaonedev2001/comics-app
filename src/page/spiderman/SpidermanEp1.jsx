...
const SpidermanEp1 = () => {
  ...
  {/*1 Page */}
    ...
    {/*2 Backgroud-Img */}
        <img className=' max-w-full ' src="spiderman-img/ep1/full-1.png" alt="" />
    {/*3 Box-Content */}
  ...
  {/* 2 */}
      <div className='box-1 relative'>
        <img className='box-items-1 max-w-full ' src="spiderman-img/ep1/full-2.png" alt="" />
        <div className='absolute inset-0 '>
          <div className='max-h-[100%] h-[1800px]'>
    ...
    {/* 3 */}
       <div className='box-1 relative'>
        <img className='box-items-1 max-w-full ' src="spiderman-img/ep1/full-3.png" alt="" />
        <div className='absolute inset-0 '>
          <div className='max-h-[100%] h-[1800px]'>
      ...
      {/* 4 */}
      <div className='box-1 relative'>
      <img className='box-items-1 max-w-full ' src="spiderman-img/ep1/full-4.png" alt="" />
      <div className='absolute inset-0 '>
        <div className='max-h-[100%] h-[1800px]'>
        <div className='flex flex-row  items-center relative top-[2%]  mx-[13%]  h-[17%] '>
          ...
          <div className='flex flex-row gap-2 items-center relative top-[4%]  mx-[4%]  h-[50%] '>
                ...
                <div className='w-[39%] flex flex-col items-center py-[8%] justify-between h-full   '> 
                  <motion.div className='w-[100%]  h-[38%] border-[1px] border-black'
    ...
    {/* 5 */}
    <div className='box-1 relative'>
      <img className='box-items-1 max-w-full ' src="spiderman-img/ep1/full-5.png" alt="" />
      <div className='absolute inset-0 '>
        <div className='max-h-[100%] h-[1800px]'>
        <div className='flex flex-row  items-center relative top-[38%]  mx-[7%]  h-[19%] '>
          ...
          <div className='flex flex-row justify-center  items-center relative top-[39%]  mx-[7%]  h-[33%] '>
                <motion.div className='w-[47%]  h-full border-[1px] border-black'
    ...
    {/* 6 */}
    <div className='box-1 relative'>
      <img className='box-items-1 max-w-full ' src="spiderman-img/ep1/full-6.png" alt="" />
      <div className='absolute inset-0 '>
        <div className='max-h-[100%] h-[1800px]'>
        <div className='flex flex-row justify-between items-center relative top-[0%]  mx-[8%]  h-[32%] '>
                ...
                <motion.div className='w-[20%]  h-full border-[1px] border-black'
                        initial={{opacity:0,x:-75}}          
                        whileInView={{opacity:1,x:0}}              
                        transition={{duration: 0.5,delay: 0.50}}
                        viewport={{ once: true }} //เล่นครั้งเดียว
                ...
                <motion.div className='w-[22%]  h-full border-[1px] border-black'
                        initial={{opacity:0,x:-75}}          
                        whileInView={{opacity:1,x:0}}              
                        transition={{duration: 0.5,delay: 0.50}}
                        viewport={{ once: true }} //เล่นครั้งเดียว
                ...
                <motion.div className='w-[24%]  h-full border-[1px] border-black'
                        initial={{opacity:0,x:-75}}          
                        whileInView={{opacity:1,x:0}}              
                        transition={{duration: 0.5,delay: 0.50}}
                        viewport={{ once: true }} //เล่นครั้งเดียว
